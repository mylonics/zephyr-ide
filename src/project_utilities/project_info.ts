...
import { RunnerProfile, formatBindLabel, loadRunnerProfiles, findRunnerProfile } from "./runner_profiles";
...
export interface BuildDetails {
  ...
  /** Pre-rendered labels for each slot. */
...
export function getBuildDetails(wsConfig: WorkspaceConfig, projectName: string, buildName: string): BuildDetails | undefined {
  ...
  const slotLabels = {
    flash: formatBindLabel(profile?.flash),
    debug: formatBindLabel(profile?.debug),
    attach: formatBindLabel(profile?.attach),
  };
