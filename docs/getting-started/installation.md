---
title: Install Zephyr IDE for VS Code - Get Started with Zephyr RTOS Development
...
4. [Install the Zephyr SDK](sdk-installation.md) for cross-compilation support
