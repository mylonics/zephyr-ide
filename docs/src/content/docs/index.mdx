...
<CardGrid>
  <LinkCard title="Getting Started" href="/getting-started/installation/" description="Install and set up Zephyr IDE" />
  <LinkCard title="User Guide" href="/user-guide/project-setup/" description="Learn how to use Zephyr IDE" />
